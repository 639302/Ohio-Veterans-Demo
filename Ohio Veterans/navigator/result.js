...
function showResults(answers) {
  ...
  // Lit's boolean-attribute converter treats attribute *presence* as true
  // regardless of value, so the default action link can only be turned off
  // via the JS property, not an `action="false"` HTML attribute.
  recapBanner.action = false;
  recapBanner.message = buildRecapBanner(answers);
