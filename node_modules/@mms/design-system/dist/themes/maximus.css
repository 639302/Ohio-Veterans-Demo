...
[data-theme="maximus"] {
  ...
  /* Avenir Next LT Pro is licensed to Maximus but is not redistributed with
     this package, so the fallback is what most consumers will actually see.
     ...
     Linux, so type is at least consistent until the licensed font is installed. */
